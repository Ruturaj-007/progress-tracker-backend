...
public class TaskList {
    ...
    @OneToMany(mappedBy = "taskList", cascade = { // The Task entity owns the FK column task_list_id
            CascadeType.REMOVE,  // Deleting a TaskList → deletes all its Tasks
            CascadeType.PERSIST  // Saving a new TaskList → automatically persists its Tasks
    })
    private List<Task> tasks;    // One taskList for many tasks
